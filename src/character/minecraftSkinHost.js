...
import { NameTagObject } from "@/assets/minecraft-character/nametag.js";

/**
 * Three.js canvas host for the vendored PlayerObject rig (scene, camera,
 * OrbitControls, EffectComposer, loadSkin via skinview-utils).
 */
export class MinecraftSkinHost {
    constructor(options = {}) {
        /**
...
export { IdleAnimation, WaveAnimation, HitAnimation } from "@/assets/minecraft-character/animation.js";
export { PlayerObject } from "@/assets/minecraft-character/model.js";