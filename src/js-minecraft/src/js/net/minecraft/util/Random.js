...
export default class Random {
    ...
    setSeed(n) {
        ...
        if (typeof n === "number") {
            long = Long.fromInt(n);
        } else if (n && typeof n === "object" && typeof n.xor === "function" && typeof n.and === "function") {
            // Duck-type Long — `n instanceof Long` breaks when two module graphs (e.g. @labymc/ alias
            // vs. relative ../libraries/long.js) each instantiate their own Long constructor in dev.
            long = n;
        } else {
