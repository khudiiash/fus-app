...
<template>
  <div class="flex flex-col min-h-screen min-h-dvh">
    ...
    <!-- ── Top bar ──────────────────────────────────────────────────────── -->
    <header class="top-bar sticky top-0 z-40 px-4 pb-3">
    ...
    <!-- ── Page content ─────────────────────────────────────────────────── -->
    <main class="flex-1 max-w-2xl mx-auto w-full px-4 py-5 pb-[5.5rem]">
      <RouterView />
    </main>
    ...
    <nav class="bottom-nav fixed bottom-0 left-0 right-0 z-40">
      <div class="flex max-w-2xl mx-auto px-2 py-1">
        ...
        >
          ...
          <span class="text-[9px] font-extrabold tracking-wide z-10 relative leading-none">{{ item.label }}</span>
        </RouterLink>
      </div>
    </nav>
